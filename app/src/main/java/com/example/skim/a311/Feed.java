...
public class Feed extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        c.add(new Crime("9 PM", "May 19th", "Shirley Avenue", "Robbery"));
        c.add(new Crime("8 PM", "May 19th", "6th Street", "Aggravated Assault"));
        c.add(new Crime("3 PM", "May 19th", "Albert Street", "Auto Theft"));
        c.add(new Crime("1 PM", "May 19th", "Saxton Street", "Theft"));
