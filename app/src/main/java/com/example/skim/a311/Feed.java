...
public class Feed extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        c.add(new Crime("9 AM","May 19th","Birchwood Drive","Burglary"));
        c.add(new Crime("4 AM","May 19th","West Hall Road","Aggravated Assault"));
