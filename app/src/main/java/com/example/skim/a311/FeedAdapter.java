 ...
 */
public class FeedAdapter extends ArrayAdapter<Crime> {

    Context context;
    private ArrayList<Crime> courses;
    private static LayoutInflater inflater = null;

    public FeedAdapter(ArrayList<Crime> data, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.im = (ImageView) rowView.findViewById(R.id.icon);
